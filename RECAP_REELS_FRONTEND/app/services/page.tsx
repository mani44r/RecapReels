    ...
    >
      ...
      <div className="text-center mt-auto relative z-10 pt-6 border-t border-white/5">
        <motion.button
          ...
          disabled={loading}
          className={`w-full py-4 px-8 bg-white text-black font-bold text-sm uppercase tracking-widest rounded-full shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-all duration-300 flex items-center justify-center gap-3 ${
            loading ? 'opacity-70 cursor-not-allowed' : 'hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] hover:bg-neutral-200'
          }`}
        >
          {loading ? (
            <>
